<template>
  <a-spin :spinning="confirmLoading">
    <JFormContainer :disabled="disabled">
      <template #detail>
        <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol" name="CsCareRecordForm">
          <a-row>
						<a-col :span="24">
							<a-form-item label="所属公司" v-bind="validateInfos.companyId" id="CsCareRecordForm-companyId" name="companyId">
								<a-input v-model:value="formData.companyId" placeholder="请输入所属公司"  allow-clear ></a-input>
							</a-form-item>
						</a-col>
						<a-col :span="24">
							<a-form-item label="所属事务所" v-bind="validateInfos.officeId" id="CsCareRecordForm-officeId" name="officeId">
						...
						<a-col :span="24">
							<a-form-item label="服务时间" v-bind="validateInfos.recordTime" id="CsCareRecordForm-recordTime" name="recordTime">
								<a-date-picker placeholder="请选择服务时间"  v-model:value="formData.recordTime" showTime value-format="YYYY-MM-DD HH:mm:ss" style="width: 100%"  allow-clear />
							</a-form-item>
						</a-col>
						<a-col :span="24">
							<a-form-item label="服务内容" v-bind="validateInfos.serviceContent" id="CsCareRecordForm-serviceContent" name="serviceContent">
								<a-textarea v-model:value="formData.serviceContent" :rows="4" placeholder="请输入服务内容" />
							</a-form-item>
						</a-col>
						<a-col :span="24">
							<a-form-item label="备注" v-bind="validateInfos.note" id="CsCareRecordForm-note" name="note">
...
<script lang="ts" setup>
  ...
  const validatorRules = reactive({
    ...
    employeeId: [{ required: true, message: '请输入执行员工!'},],
  });
