  ...
  <div>
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      ...
      <template #tableTitle>
        ...
        <j-upload-button type="primary" v-auth="'qr:biz_device:importExcel'" preIcon="ant-design:import-outlined" @click="onImportXls"
          >导入</j-upload-button
        >
        <a-dropdown v-if="selectedRowKeys.length > 0">
          ...
          <a-button v-auth="'qr:biz_device:deleteBatch'"
            >批量操作
...
<script lang="ts" name="qr-bizDevice" setup>
  ...
  function handlePrint(record: Recordable) {
    ...
    openPrintModal(true, { url, deviceType: record.no });
  }
  /**
   * 删除事件
   */
