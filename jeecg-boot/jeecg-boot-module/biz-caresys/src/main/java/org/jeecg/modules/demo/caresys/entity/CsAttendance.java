 ...
 */
@Data
@TableName("cs_attendance")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description="cs_attendance")
public class CsAttendance implements Serializable {
	...
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
    @Schema(description = "打卡上班时间")
    private java.util.Date clockIn;
	/**打卡下班时间*/
	@Excel(name = "打卡下班时间", width = 20, format = "yyyy-MM-dd HH:mm:ss")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
    @Schema(description = "打卡下班时间")
    private java.util.Date clockOut;
	/**是否迟到*/
	@Excel(name = "是否迟到", width = 15)
    @Schema(description = "是否迟到")
    private java.lang.Integer late;
	/**是否早退*/
	@Excel(name = "是否早退", width = 15)
    @Schema(description = "是否早退")
    private java.lang.Integer earlyLeave;
}
