...
@Schema(description="cs_feedback")
public class CsFeedback implements Serializable {
	...
	/**来源（家属/员工）*/
	@Excel(name = "来源（家属/员工）", width = 15)
    @Schema(description = "来源（家属/员工）")
    private java.lang.String source;
	/**关联老人或员工*/
	@Excel(name = "关联老人或员工", width = 15)
    @Schema(description = "关联老人或员工")
