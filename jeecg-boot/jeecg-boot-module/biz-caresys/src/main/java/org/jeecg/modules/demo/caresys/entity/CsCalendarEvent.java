 ...
 */
@Data
@TableName("cs_calendar_event")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description="cs_calendar_event")
public class CsCalendarEvent implements Serializable {
	...
	/**事件类型（访视/培训/检修等）*/
	@Excel(name = "事件类型（访视/培训/检修等）", width = 15)
    @Schema(description = "事件类型（访视/培训/检修等）")
    private java.lang.String eventType;
	/**事件日期*/
	@Excel(name = "事件日期", width = 15, format = "yyyy-MM-dd")
