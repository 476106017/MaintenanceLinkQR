 ...
 */
@Data
@TableName("cs_care_record")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description="cs_care_record")
public class CsCareRecord implements Serializable {
	...
	/**执行员工*/
	@Excel(name = "执行员工", width = 15)
    @Schema(description = "执行员工")
    private java.lang.String employeeId;
	/**服务时间*/
	@Excel(name = "服务时间", width = 20, format = "yyyy-MM-dd HH:mm:ss")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
